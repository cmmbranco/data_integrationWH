drop database IF EXISTS sequelmovie;
...
insert into genre values (0005, 'Science Fiction', 'Films of speculative fiction, typically dealing with imaginative concepts such as futuristic science and tech');
